...
export class TraderDetailApplication {
  ...
  getTraderDetail(provider: Provider, traderAddress: string): Promise<TraderRiskDto | null> {
    return this.traderDetailService.getTraderDetail(provider, traderAddress);
  }
}
